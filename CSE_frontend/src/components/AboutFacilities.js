                ...
                <div style={{ background: '#E8E8E8', padding: '10px' }}>
                    <Row style={{ backgroundColor: '#f9f9f9', padding: '10px' }}>
                        <font size="4" color="#6a7eff">
                            <Link to={`/student-club/학부-행정실`}>학부 행정실</Link>
                        </font>
                    ...
                    <Row style={{ backgroundColor: '#f9f9f9', padding: '10px' }}>
                        <font size="4" color="#6a7eff">
                            <Link to={`/student-club/S-Lab`}>S-Lab</Link>
                        </font>
                    ...
                    <Row style={{ backgroundColor: '#f9f9f9', padding: '10px' }}>
                        <font size="4" color="#6a7eff">
                            <Link to={`/student-club/소프트웨어-실험실`}>소프트웨어 실험실</Link>
                        </font>
                    ...
                    <Row style={{ backgroundColor: '#f9f9f9', padding: '10px' }}>
                        <font size="4" color="#6a7eff">
                            <Link to={`/student-club/하드웨어-실험실`}>하드웨어 실험실</Link>
                        </font>
                    ...
                    <Row style={{ backgroundColor: '#f9f9f9', padding: '10px' }}>
                        <font size="4" color="#6a7eff">
                            <Link to={`/student-club/해동학술정보실`}>해동학술정보실</Link>
                        </font>
                    ...
                    <Row style={{ backgroundColor: '#f9f9f9', padding: '10px' }}>
                        <font size="4" color="#6a7eff">
                            <Link to={`/student-club/학생-공간-및-동아리-방`}>학생 공간 및 동아리 방</Link>
                        </font>
                    ...
                    <Row style={{ backgroundColor: '#f9f9f9', padding: '10px' }}>
                        <font size="4" color="#6a7eff">
                            <Link to={`/student-club/세미나실`}>세미나실</Link>
                        </font>
                    ...
                    <Row style={{ backgroundColor: '#f9f9f9', padding: '10px' }}>
                        <font size="4" color="#6a7eff">
                            <Link to={`/student-club/서버실`}>서버실</Link>
                        </font>
