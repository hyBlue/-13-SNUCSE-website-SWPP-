                ...
                <div style={{ background: '#E8E8E8', padding: '10px' }}>
                    <Row style={{ backgroundColor: '#f9f9f9', padding: '10px' }}>
                        <font size="4" color="#6a7eff">
                            <Link to={`/about/student-club/가디언`}>가디언</Link>
                        </font>
                    ...
                    <Row style={{ backgroundColor: '#f9f9f9', padding: '10px' }}>
                        <font size="4" color="#6a7eff">
                            <Link to={`/about/student-club/바쿠스`}>바쿠스</Link>
                        </font>
                    ...
                    <Row style={{ backgroundColor: '#f9f9f9', padding: '10px' }}>
                        <font size="4" color="#6a7eff">
                            <Link to={`/about/student-club/사커301`}>사커301</Link>
                        </font>
                    ...
                    <Row style={{ backgroundColor: '#f9f9f9', padding: '10px' }}>
                        <font size="4" color="#6a7eff">
                            <Link to={`/about/student-club/슈타인`}>슈타인</Link>
                        </font>
                    ...
                    <Row style={{ backgroundColor: '#f9f9f9', padding: '10px' }}>
                        <font size="4" color="#6a7eff">
                            <Link to={`/about/student-club/스눕스`}>스눕스</Link>
                        </font>
                    ...
                    <Row style={{ backgroundColor: '#f9f9f9', padding: '10px' }}>
                        <font size="4" color="#6a7eff">
                            <Link to={`/about/student-club/와플스튜디오`}>와플스튜디오</Link>
                        </font>
                    ...
                    <Row style={{ backgroundColor: '#f9f9f9', padding: '10px' }}>
                        <font size="4" color="#6a7eff">
                            <Link to={`/about/student-club/유피넬`}>유피넬</Link>
                        </font>
