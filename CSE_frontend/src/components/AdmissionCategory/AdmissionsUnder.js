...
고교 졸업생 자격으로 수시 모집과 정시 모집에 지원할 수 있으며, 학사 학위 소지자는 학사 편입학에 지원할 수 있습니다.<br />
                        <font size="5">&middot;</font>&nbsp;<Link to='/admissions/undergraduate/susi/'>수시 모집</Link><br />
                        <font size="5">&middot;</font>&nbsp;<Link to='/admissions/undergraduate/jeongsi/'>정시 모집</Link><br />
                        <font size="5">&middot;</font>&nbsp;<Link to='/admissions/undergraduate/transfer/'>학사 편입학</Link><br />
                     </Row>
                </div>
            </div>
        )
